	...
	?>
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">Vit University<span>Vellore</span></p>
			</div>
			<div>
				<i class="fa fa-phone"></i>
				<p style="font-size:20px">9030377377,9003329219</p>
			</div>
			<div>
				<i class="fa fa-envelope"></i>
				<p style="font-size:20px"><a href="mailto:n.jaswanthsai@gmail.com" style="color:white">n.jaswanthsai@gmail.com</a></p>
			</div>
		</div>
